...
polskie_znaki_m	db	0, 0A4H, 8FH, 0A8H, 9DH, 0E3H, 0E0H, 97H, 8DH, 0BDH
polskie_znaki_d db	0, 0A5H, 86H, 0A9H, 88H, 0E4H, 0A2H, 98H, 0ABH, 0BEH
koniec			db	?
.code
_main PROC
...
w_ptl:	cmp		dl, polskie_znaki_m[esi]
		...
		mov		dl, polskie_znaki_d[esi] ; zamiana du¿ej litery na ma³¹
		mov		magazyn[ebx], dl ; przes³anie ma³ej litery do tablicy
		jmp		exit
rozne:	dec		esi	; j--
		jnz		w_ptl


dalej:	add		dl, 20H										; zamiana na wielkie litery
		mov		magazyn[ebx], dl
exit:	inc		ebx	
		dec		ecx	; i--
		jnz		ptl
